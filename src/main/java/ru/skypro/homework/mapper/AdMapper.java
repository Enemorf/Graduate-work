...
public interface AdMapper {
    ...
    @Mapping(target = "author", source = "adEntity.userId.id")
    @Mapping(target = "image", source = "adEntity.imageEntity.path")
    AdDto adEntityToAdDto(AdEntity adEntity);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "price", source = "extendedAdDtoLite.price")
    @Mapping(target = "description", source = "extendedAdDtoLite.description")
    @Mapping(target = "imageEntity", source = "imageEntity")
    @Mapping(target = "usersId", source = "userEntity")
    AdEntity extendedAdDtoLiteUserEntityImageEntityToAdEntity(ExtendedAdDtoLite extendedAdDtoLite, UserEntity userEntity, ImageEntity imageEntity);
